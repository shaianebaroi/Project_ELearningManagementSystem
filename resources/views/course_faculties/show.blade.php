...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "course_code" name = "course_code" class = "form-control" value = '{{ $courseFaculties->course_code }}'/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "section_no"> Section No </label>
        <input type = "text" id = "section_no" name = "section_no" class = "form-control" value = '{{ $courseFaculties->section_no }}'/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "course_faculty"> Course Faculty</label>
        <input type = "text" id = "course_faculty" name = "course_faculty" class = "form-control" value = '{{ $courseFaculties->course_faculty }}'/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "status"> Status </label>
        <input type = "text" id = "status" name = "status" class = "form-control" value = '{{ $courseFaculties->status }}'/>
      </div>
