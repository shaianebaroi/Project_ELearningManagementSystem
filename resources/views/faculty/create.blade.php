...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "faculty_initials" name = "faculty_initials" class = "form-control"/>
      </div>
      <div class = "col-sm-10 my-1" style="margin:auto">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "faculty_designation" name = "faculty_designation" class = "form-control"/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "faculty_image"> Faculty Image URL </label>
        <input type = "text" id = "faculty_image" name = "faculty_image" class = "form-control"/>
      </div>
