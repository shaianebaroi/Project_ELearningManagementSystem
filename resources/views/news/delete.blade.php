...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "news_date" name = "news_date" class = "form-control" value = '{{ $news->news_date }}' disabled/>
      </div>
      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "news_title"> News Title </label>
        <input type = "text" id = "news_title" name = "news_title" class = "form-control" value = '{{ $news->news_title }}' disabled/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "news_details"> News Details </label>
        <input type = "text" id = "news_details" name = "news_details" class = "form-control" value = '{{ $news->news_details }}' disabled/>
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "status"> Status </label>
        <input type = "text" id = "status" name = "status" class = "form-control" value = '{{ $news->status }}' disabled/>
      </div>
