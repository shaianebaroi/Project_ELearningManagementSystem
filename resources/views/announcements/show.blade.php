...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "date" name = "date" class = "form-control" value = '{{ $announcements->date }}' />
      </div>

      <div class = "col-sm-10 my-1" style="margin:auto">
        <label for = "announcement"> Announcement </label>
        <input type = "text" id = "announcement" name = "announcement" class = "form-control" value = '{{ $announcements->announcement }}'/>
      </div>
