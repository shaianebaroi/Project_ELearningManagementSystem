...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "announcement_id" name = "announcement_id" class = "form-control" disabled/>
      </div>
      <div class = "col-sm-10 my-1" style="margin:auto">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "announcement" name = "announcement" class = "form-control"/>
      </div>
