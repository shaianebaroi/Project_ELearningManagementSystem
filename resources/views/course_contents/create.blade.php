...
<x-app-layout>
    ...
    <form action = "" method ="post">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "content_id" name = "content_id" class = "form-control" disabled/>
      </div>
      <div class = "col-sm-10 my-1" style="margin:auto">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "section_no" name = "section_no" class = "form-control"/>
      </div>
      <div class = "col-sm-10 my-1" style="margin:auto">
      ...
      <div class = "col-sm-10 my-1" style="margin:auto">
        ...
        <input type = "text" id = "content_details" name = "content_details" class = "form-control"/>
      </div>
